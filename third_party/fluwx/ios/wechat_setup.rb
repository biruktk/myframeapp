...
begin
    ...
    warn('[fluwx] Skipping WeChat plist setup because the optional Ruby plist gem is unavailable. MyFrame declares the required WeChat iOS settings in ios/Runner/Info.plist and Runner.entitlements.')
    exit 0
end
require 'optparse'
require 'uri'
